  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      !col1 && !queryMatches.mobile && _react2.default.createElement(
        'div',
        { className: 'fixed-top fixed-right ' + (queryMatches.desktop && 'space-left20') },
        _react2.default.createElement('div', { className: 'fill-light col6 pin-right' })
      ),
      queryMatches.desktop && _react2.default.createElement(
        'div',
        { className: 'space-top5 scroll-styled pad1 width20 sidebar fixed-left fill-dark dark' },
      ...
      _react2.default.createElement(
        'div',
        { className: '' + (queryMatches.desktop && 'space-left20') },
        _react2.default.createElement(
          'div',
      ...
      _react2.default.createElement(
        'div',
        { className: 'fixed-top ' + (queryMatches.desktop && 'space-left20') },
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            queryMatches.desktop ? _react2.default.createElement('a', {
              ...
              className: 'icon quiet caret-' + (col1 ? 'right' : 'left') + ' fill-darken0 round' }) : null
          )
        )
      ),
      _react2.default.createElement(
        'div',
        { className: 'fill-dark dark bottom-shadow fixed-top ' + (queryMatches.tablet ? 'pad1y pad2x col6' : 'pad0 width20') },
        _react2.default.createElement('a', { href: '/', className: 'active space-top1 space-left1 pin-topleft icon round dark ' + _custom.brandClasses }),
        _react2.default.createElement(
          'div',
          { className: 'strong small pad0\n          ' + (queryMatches.mobile ? 'space-left3' : '') + '\n          ' + (queryMatches.tablet ? 'space-left2' : 'space-left5 line-height10') },
